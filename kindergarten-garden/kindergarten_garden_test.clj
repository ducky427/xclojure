...
(deftest garden-test
  (is (= [:radishes :clover :grass :grass] (:alice (garden/garden "RC\nGG"))))
  (is (= [:violets :clover :radishes :clover] (:alice (garden/garden "VC\nRC")))))

(def small-garden (garden/garden "VVCG\nVVRC"))
(deftest small-garden-test
  (is (= [:clover :grass :radishes :clover] (:bob small-garden))))

(def medium-garden (garden/garden "VVCCGG\nVVCCGG"))
...
(def full-garden (garden/garden "VRCGVVRVCGGCCGVRGCVCGCGV\nVRCCCGCRRGVCGCRVVCVGCGCV"))
...
(def surprise-garden (garden/garden "VCRRGVRG\nRVGCCGCV" ["Samantha" "Patricia" "Xander" "Roger"]))
